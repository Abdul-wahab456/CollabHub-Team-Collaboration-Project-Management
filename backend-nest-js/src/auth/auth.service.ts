...
export class AuthService {
  // validateGoogleUser(user: any): { access_token: any; } | PromiseLike<{ access_token: any; }> {
  ...
  if (existingUser) {
    ...
    if (!existingUser.passwordHash) {
      throw new ConflictException('Email already registered with Google. Please use Google Sign-In.');
    }
